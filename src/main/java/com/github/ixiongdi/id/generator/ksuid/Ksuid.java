package com.github.ixiongdi.id.generator.ksuid;
...
public class Ksuid implements Comparable<Ksuid>, Serializable {
     ...
     */
    public String asRaw() {
        return HexUtil.encodeHexStr(ksuidBytes);
    }
    ...
    public String getPayload() {
        return HexUtil.encodeHexStr(payload);
    }
    ...
    public String toString() {
        return Base62.encode(ksuidBytes);
    }
    ...
    public static final class Builder {
        ...
        public Builder withKsuidString(final String ksuidString) {
            this.ksuidBytes = Base62.decode(ksuidString);
            return this;
        }
