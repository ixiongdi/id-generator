...
class Base16Test {
    ...
    void testLeadingZeros() {
        ...
        String encoded = uno.xifan.id.base.Base16.encode(data);

        assertEquals("000000010203", encoded);
        assertArrayEquals(data, uno.xifan.id.base.Base16.decode(encoded));
    }
    ...
    void testInvalidInput() {
        // 非法字符测试
        assertThrows(IllegalArgumentException.class,
                () -> uno.xifan.id.base.Base16.decode("GHIJKL"));

        // 奇数长度测试
        assertThrows(IllegalArgumentException.class,
                () -> uno.xifan.id.base.Base16.decode("123"));
    }
}